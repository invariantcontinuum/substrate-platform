...
- **[Technical Implementation Spec](docs/architecture/technical-spec.md)**: Deep dive into the GraphRAG pipeline, Rust ingestion, and tech stack choices.

### 🚀 Product
- **[Product Requirements](docs/product/requirements.md)**: Detailed feature requirements, user flows, and personas.
- **[Strategy & Market](docs/product/strategy.md)**: Deployment models, pricing, and go-to-market strategy.
...
### 💻 Development
- **[Frontend Guide](docs/development/frontend.md)**: Frontend architecture, component library, and state management.
...
- **[Refactor History](docs/development/refactor-history.md)**: Summary of past refactoring efforts.

### ⚙️ Deployment
- **[Docker Setup](docs/deployment/docker.md)**: Full Docker deployment guide.
- **[Kubernetes Guide](docs/deployment/kubernetes.md)**: Deployment manifests and specificaitons.
- **[Docker Cheatsheet](docs/deployment/docker-cheatsheet.md)**: Quick reference commands.
...
For detailed setup instructions, see the [Contributing Guide](docs/development/contributing.md).
